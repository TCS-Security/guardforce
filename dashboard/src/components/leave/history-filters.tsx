...
import { cn } from "cn";
import { filterBarClass } from "@/components/gf/filter-bar";
...
export function HistoryFiltersForm({
  ...
  return (
    <form method="get" action="/leave" className={cn("reveal", filterBarClass)} aria-label="Filter history">
      <input type="hidden" name="tab" value="history" />
      <Field className="w-36">
        <Label htmlFor="f-status" className="eyebrow">Status</Label>
      ...
      <Field className="w-36">
        <Label htmlFor="f-type" className="eyebrow">Type</Label>
      ...
      <Field className="w-52">
        <Label htmlFor="f-site" className="eyebrow">Site</Label>
      ...
      <Field className="w-56">
        <Label htmlFor="f-guard" className="eyebrow">Guard</Label>
      ...
      <Field className="w-40">
        <Label htmlFor="f-from" className="eyebrow">From</Label>
        <Input id="f-from" name="from" type="date" defaultValue={filters.from ?? ""} className="font-mono text-xs md:text-xs" />
      </Field>
      <Field className="w-40">
        <Label htmlFor="f-to" className="eyebrow">To</Label>
        <Input id="f-to" name="to" type="date" defaultValue={filters.to ?? ""} className="font-mono text-xs md:text-xs" />
      </Field>
